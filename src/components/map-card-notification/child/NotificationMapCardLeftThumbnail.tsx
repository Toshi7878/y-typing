...
const NotificationMapCardLeftThumbnail = (props: MapLeftThumbnailProps) => {
  const {
    src = "",
    fallbackSrc = "",
    alt = "",
  ...
  const pathSegment = pathname.split("/")[1]; // "/type"を取得
...
export default NotificationMapCardLeftThumbnail;
